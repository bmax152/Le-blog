...
if (isset($_SESSION["login"])) {
    ...
    if (isset($_GET['idArticle'])) {
        try {
            ...
            $sql = 'SELECT * FROM test_blog WHERE Id = :id AND Auteur LIKE :auteur';
            ...
            while ($ligne = $resultat->fetch()) {
                ...
                $valueTitre = $ligne['Titre'];
                $valueComm = $ligne['Commentaire'];
                $valueImg = $ligne['Image_article'];
                $ok = false;
            }
...
?>
    ...
    <body>
        <main id="mainAjout">
            <h1>Formulaire de modification de contenu du Blog</h1>

            <form action="update_bdd.php?idArticle=<?php echo $_GET['idArticle']; ?>" id="formUpdateBlog" method="post" enctype="multipart/form-data">
                <div class="formAjout">
