<?php
session_start();
if (isset($_SESSION['login']) && $_POST['titre'] != "" && $_POST['comm'] != "" && isset($_GET['idComm'])) {
?>
    ...
    <body>
        ...
        try {
            ...
            if ($_FILES['uploadImg']['name'] != "") {
                ...
                $tempImg = ", Image_comm = :img";
            }

            $sql = "UPDATE test_blog_comm SET Titre_comm = :titre, Commentaire_comm = :comm" . $tempImg . " , Auteur_comm = :auteur, Modifier_comm = :date_modi WHERE Id = :id AND Auteur_comm LIKE :auteur";
            ...
            if ($_FILES['uploadImg']['error'] && $_FILES['uploadImg']['error'] != 4) {
                ...
                if ((isset($_FILES['uploadImg']['name']) && ($_FILES['uploadImg']['error'] == UPLOAD_ERR_OK)) || $_FILES['uploadImg']['error']  == 4) {
                    ...
                    if (isset($_FILES['uploadImg']['name']) && $_FILES['uploadImg']['error']  != 4) {
                        ...
                        $sql3 = "SELECT Image_comm FROM test_blog_comm WHERE Id = :id";
                        ...
                        if ($okDoublon) {
                            $date_img = date("H-i-s");
                            $newName = $_GET['idComm'] . $date_img . $_FILES['uploadImg']['name'];
